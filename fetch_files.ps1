...
$cmd1 = $ssh.RunCommand("cat /root/movie-app/server.js")
Set-Content "server.js" $cmd1.Result

$cmd2 = $ssh.RunCommand("cat /root/movie-app/public/index.html")
Set-Content "public/index.html" $cmd2.Result
