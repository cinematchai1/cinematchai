...
$cmd = $ssh.RunCommand("curl -sL -A 'Mozilla/5.0' https://dpaste.com/4Z9XZCNF5.txt -o /root/movie-app/server.js && curl -sL -A 'Mozilla/5.0' https://dpaste.com/3CQ9AA9SX.txt -o /root/movie-app/public/index.html && pm2 restart movie-app")
