...
$cmd = $ssh.RunCommand("curl -sL -A 'Mozilla/5.0' https://dpaste.com/GFHC73JZQ.txt -o /root/movie-app/server.js && pm2 restart movie-app && sleep 1 && pm2 logs movie-app --lines 20 --nostream 2>&1")
Write-Host "RESTART AND LOGS:"
