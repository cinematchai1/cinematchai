...
$cmd1 = $ssh.RunCommand("echo `"$nodeScript`" | base64 -w 0")

$remoteCmd = "echo `"" + $cmd1.Result + "`" | base64 -d > /root/movie-app/patch.js && node /root/movie-app/patch.js && pm2 restart movie-app"
$cmd2 = $ssh.RunCommand($remoteCmd)
