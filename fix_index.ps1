...
$cmd = $ssh.RunCommand("curl -sL -A 'Mozilla/5.0' https://dpaste.com/AFRZ4864W.txt -o /root/movie-app/public/index.html && ls -la /root/movie-app/public/index.html && pm2 restart movie-app")
